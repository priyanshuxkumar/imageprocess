...
import { uploadImage, transformImage, getImageById, getTransformedImages, destroyImage, getAllImages, checkTransformStatus } from "../controllers/image.controller";
...
router.route("/:id/status").get(authMiddleware, checkTransformStatus);
